# Power Automate & Workflow Automation Projects

This section showcases practical workflow automation projects built around Microsoft Power Automate and related business systems.

The projects focus on reducing manual work, improving process consistency and turning business requirements into automated workflows.
...
**Workflow:**  
Outlook email → Power Automate trigger → Attachment retrieval → SharePoint file storage → Invoice Register record creation → Approval routing → Approve/Reject decision → SharePoint status update

**Tools used:**  
Microsoft Power Automate, SharePoint, Outlook, Microsoft 365

**Capabilities demonstrated:**
- Email-triggered workflow automation
- Invoice ingestion
- Attachment handling
...
- Trigger filtering to prevent recursive approval emails
